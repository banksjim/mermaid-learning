...
```mermaid
  gantt
    ...
    Future task2   :         desc4, after desc3, 5d

    section Critical tasks
    Completed task in the critical lane : crit, done, 2014-01-06, 24h
    Implement parser and JSON           : crit, done, after desc1, 2d 
    ...
    Describe gantt syntax           : active, a1, after desc1, 3d 
    Add gantt diagram to demo page  : after a1, 20h 
    Add another diagra to demo page : doc1, after a1, 48h

    section Last section             
    Describe gantt syntax            : after doc1 
    Add gantt to demo page           : 20h 
    Add another diagram to demo page : 48h 
```

It's possible to set multiple dependencies separated by space. Example:

```mermaid
  gantt
    apple  : a, 2017-07-20, 1w
    banana : b, 2017-07-23, 1d
...
```mermaid
  gantt
    ...
    Intial milestone : milestone, m1, 17:49, 2min
    taska2           : 10min
    taska3           : 5min
...
More info at: https://github.com/d3/d3-time-format/tree/v4.0.0#locale_format
...
More info at: https://github.com/d3/d3-time#interval_every
